...
def main():
    if config.lang == 'EN':
        ...
        print('Selected incorrect lang (in config.py)')


def main_en():
    req = input("Write request: ")
    ...
    if playlist_results is not None:
        ...
        for i in range(10):
            try:
                ...
                print('Author: ' + playlist['channel']['name'])
                print('Link to channel: ' + playlist['channel']['link'])
                print('Video count: ' + str(playlist['video_count']))
                print('Link: https://www.youtube.com/playlist?' + str(playlist['link']).split('&')[1])
                print('Watch: ' + playlist['link'])
            except:
                pass
    ...
    if video_results is not None:
        ...
        for i in range(10):
            try:
                ...
                print('Author: ' + video['channel']['name'])
                print('Link to channel: ' + video['channel']['link'])
                print('Posted ' + video['published_date'])
                print('Views: ' + str(video['views']))
                print('Length: ' + video['length'])
                print('Description: ' + video['description'])
                print('Watch: ' + video['link'])
            except:
                pass
